        ...
        <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl relative group overflow-hidden">
            ...
            {state === 'PAID' ? (
                <div className="flex flex-col items-center justify-center py-8 text-center space-y-4 animate-in zoom-in duration-300">
                    <div className="w-16 h-16 bg-emerald-500/20 text-emerald-400 rounded-full flex items-center justify-center text-3xl mb-2">
                        ✅
                    </div>
                    <div>
                ...
                <>
                    ...
                    <div className="relative z-10">
                        {state === 'IDLE' && (
                            <button
                                onClick={onClaim}
                                className="w-full py-3 bg-white text-black font-semibold rounded-xl hover:bg-gray-100 active:scale-95 transition-all"
                            >
                                Claim Task
                            </button>
                        )}
                        ...
                        {state === 'CLAIMED' && (
                            <button
                                onClick={onSubmit}
                                className="w-full py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-500 active:scale-95 transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)]"
                            >
                                Submit & Get Paid
                            </button>
                        )}
                        ...
                        {state === 'SUBMITTING' && (
                            <button
                                disabled
                                className="w-full py-3 bg-zinc-800 text-white/50 font-semibold rounded-xl cursor-wait"
                            >
                                Processing...
                            </button>
                        )}
